namespace NVerify.Reflection
{
  ...
  public static partial class ReflectionExtensions
  {
    ...
    {
      if (subGeneric == null)
        throw new ArgumentException("subGeneric must not be null.");
      if (baseGeneric == null)
        throw new ArgumentException("baseGeneric must not be null.");
      if (!baseGeneric.IsGenericType)
        throw new ArgumentException("baseGeneric must be a GenericType (baseGeneric.IsGenericType must be true)");
